...
urlpatterns = [
    ...
    path('carpeta/<int:carpeta_id>/subcarpeta/nueva/', views.crear_subcarpeta, name='crear_subcarpeta'),
    ...
    path('subcarpeta/eliminar/<int:subcarpeta_id>/', views.eliminar_subcarpeta, name='eliminar_subcarpeta'),
